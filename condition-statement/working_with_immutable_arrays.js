// OBJECTIVE: Add, Delete and Update data in Arrays

// Note: we cant use import function here to get the books data from function_array_methods.js since Quokka doesn't support import
...
const booksAfterDelete = booksAfterAdding.filter(
  (book) => book.isbn !== "4081484242250"
);
console.log(booksAfterDelete);

// 3) Update book object in the array
const booksAfterUpdate = booksAfterDelete.map((book) =>
  book.isbn === "9781484242216" ? { ...book, pages: 120 } : book
); // take note that ...book is the variable in the arrow function (book) and applying the rest/spread operator
